...
public class RayInteract : MonoBehaviour
{
    ...
    [HideInInspector]
    public float pickupTextCountDown;
            ...
            for (int i = 0; i < objComponents.Length; i++)
            {
                ...
                if (Input.GetKey(KeyCode.Mouse0))
                {
                    ...
                    if (addItem && doOnce == 1)
                    {
                        ...
                        hitObj.gameObject.SetActive(false); //Set item you just picked up from game world to false to make it invisible in game world. 
